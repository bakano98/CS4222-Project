...
Flash the appropriate files onto each device. 
The light-sensing node should have the compiled "nbr-part2-sender" file flashed, and the other nodes (data mules) should have the compiled "nbr-part2-requester" file flashed.